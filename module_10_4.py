...
# Класс Cafe - кафе, в котором есть определённое кол-во столов и происходит имитация
...
class Cafe:
    ...
    # Метод guest_arrival (прибытие гостей)
    ...
    # Метод discuss_guests (обслужить гостей)
